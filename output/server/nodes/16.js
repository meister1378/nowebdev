...
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/service/download/_page.svelte.js')).default;
...
export const stylesheets = ["_app/immutable/assets/16.DbHmPXI-.css"];
export const fonts = [];
